  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        '<(DEPTH)/starboard/wpe/shared/application_dispmanx.cc',
        '<(DEPTH)/starboard/wpe/shared/audio_sink_type_dispatcher.cc',
        '<(DEPTH)/starboard/wpe/shared/media_is_audio_supported.cc',
        '<(DEPTH)/starboard/wpe/shared/dispmanx_util.cc',
        '<(DEPTH)/starboard/wpe/shared/dispmanx_util.h',
        '<(DEPTH)/starboard/wpe/shared/main.cc',
        '<(DEPTH)/starboard/wpe/shared/media_is_video_supported.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/decode_target_create.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/decode_target_create.h',
        '<(DEPTH)/starboard/wpe/shared/open_max/decode_target_get_info.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/decode_target_internal.h',
        '<(DEPTH)/starboard/wpe/shared/open_max/decode_target_release.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/dispmanx_resource_pool.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/dispmanx_resource_pool.h',
        '<(DEPTH)/starboard/wpe/shared/open_max/image_decode.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/image_is_decode_supported.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/open_max_component.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/open_max_component.h',
        '<(DEPTH)/starboard/wpe/shared/open_max/open_max_component_base.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/open_max_component_base.h',
        '<(DEPTH)/starboard/wpe/shared/open_max/open_max_egl_render_component.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/open_max_egl_render_component.h',
        '<(DEPTH)/starboard/wpe/shared/open_max/open_max_image_decode_component.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/open_max_image_decode_component.h',
        '<(DEPTH)/starboard/wpe/shared/open_max/open_max_video_decode_component.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/open_max_video_decode_component.h',
        '<(DEPTH)/starboard/wpe/shared/gstreamer/gst_video_decoder.cc',
        '<(DEPTH)/starboard/wpe/shared/gstreamer/gst_video_decoder.h',
        '<(DEPTH)/starboard/wpe/shared/gstreamer/gst_video_context.cc',
        '<(DEPTH)/starboard/wpe/shared/gstreamer/gst_video_context.h',
        '<(DEPTH)/starboard/wpe/shared/gstreamer/gst_audio_decoder.cc',
        '<(DEPTH)/starboard/wpe/shared/gstreamer/gst_audio_decoder.h',
        '<(DEPTH)/starboard/wpe/shared/gstreamer/gst_audio_context.cc',
        '<(DEPTH)/starboard/wpe/shared/gstreamer/gst_audio_context.h',
        '<(DEPTH)/starboard/shared/opus/opus_audio_decoder.cc',
        '<(DEPTH)/starboard/shared/opus/opus_audio_decoder.h',
        '<(DEPTH)/starboard/wpe/shared/player_components_impl.cc',
        '<(DEPTH)/starboard/wpe/shared/system_get_property.cc',
        '<(DEPTH)/starboard/wpe/shared/system_gles2.cc',
        '<(DEPTH)/starboard/wpe/shared/thread_create_priority.cc',
        '<(DEPTH)/starboard/wpe/shared/video_renderer_sink_impl.cc',
        '<(DEPTH)/starboard/wpe/shared/video_renderer_sink_impl.h',
        '<(DEPTH)/starboard/wpe/shared/window_create.cc',
        '<(DEPTH)/starboard/wpe/shared/window_destroy.cc',
        '<(DEPTH)/starboard/wpe/shared/window_get_platform_handle.cc',
        '<(DEPTH)/starboard/wpe/shared/window_get_size.cc',
        '<(DEPTH)/starboard/wpe/shared/window_internal.cc',
        ...
        '<(DEPTH)/starboard/shared/ocdm/drm_create_system.cc',
        '<(DEPTH)/starboard/shared/ocdm/drm_system_ocdm.cc',
        '<(DEPTH)/starboard/shared/ocdm/drm_system_ocdm.h',
        '<(DEPTH)/starboard/shared/ocdm/media_is_supported.cc',
      ...
      'cflags': [
        ...
        '-Wno-reorder',
        # Generated by code in the wpe/shared/open_max.
        '-Wno-sign-compare',
